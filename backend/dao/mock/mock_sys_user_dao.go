...
import (
	dto "github.com/fansqz/fancode-backend/models/dto"
	po "github.com/fansqz/fancode-backend/models/po"
	reflect "reflect"
...
func (m *MockSysUserDao) CheckEmailIsExist(db *gorm.DB, email string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckEmailIsExist", db, email)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSysUserDaoMockRecorder) CheckEmailIsExist(db, email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckEmailIsExist", reflect.TypeOf((*MockSysUserDao)(nil).CheckEmailIsExist), db, email)
}
...
func (m *MockSysUserDao) GetUserCount(db *gorm.DB, user *po.SysUser) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserCount", db, user)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockSysUserDaoMockRecorder) GetUserCount(db, user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserCount", reflect.TypeOf((*MockSysUserDao)(nil).GetUserCount), db, user)
}
